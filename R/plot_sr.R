#' @title Plot Age-specific Nest Survival Rate
#' @description This is age-specific survival plot.
...
plot_sr <- function(x, n, xlab = "nest age", ylab = "individual age-specific nest survival rate", ...){
  plot(1:x$jj, x$sr[n,], type = "l", xlab = xlab, ylab = ylab)
}

#' @title Plot Average Survival Rate
#' @description This is nest-average age-specific survival rate plot.
...
plot_asr <- function(x, xlab = "nest age", ylab = "average age-specific nest survival rate", ...){
  plot(1:x$jj, x$asr, type = "l", xlab = xlab, ylab = ylab)
}
